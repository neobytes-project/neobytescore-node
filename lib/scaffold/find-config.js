...
/**
 * Will return the path and neobytescore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'neobytescore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'neobytescore-node.json'))
  };
}
